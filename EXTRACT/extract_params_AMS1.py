...
realisations_path = '/mnt/qrypfpr220708_americas_run_1.9.2008_try2_ams1/realizations_mem_100000000_QRYPFPR220708_Americas_Run_1.9.2008_iterations_FILESTARTREL_FILEENDREL.hdf5'
...
exportPathDistributed_country = '/mnt/distributedoutput_country_ams1_try2/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_ams1_try2/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_ams1_try2/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_ams1_try2/'
 
# input 1km salb raster of unique spatial IDs
salblim1km_path="/mnt/auxiliary_data/salblim1km-e_y-x+_AMS1.hdf5"
salb1km_path="/mnt/auxiliary_data/salb1km-e2_y-x+_AMS1.hdf5"
...
grump1km_path="/mnt/auxiliary_data/gr071km_y-x+_AMS1.hdf5" 
grump5km_path="/mnt/auxiliary_data/gr075km_y-x+_AMS1.hdf5"
#gr001km_path="/home/pwg/mbg-world/datafiles/auxiliary_data/gr001km_ken.hdf5"
 
# location of 5km hdf5  limits mask
lim5kmbnry_path="/mnt/auxiliary_data/st_mask5km-e_y-x+_AMS1.hdf5"
...
uniqueSalb_path='/mnt/examineSalb/uniqueSalb_ams1.txt'
uniqueSalbwholecountries_path='/mnt/examineSalb/uniqueSalbwholecountries_ams1.txt'
pixelN_path='/mnt/examineSalb/pixelN_ams1.txt'
pixelNwholecountries_path='/mnt/examineSalb/pixelNwholecountries_ams1.txt'
