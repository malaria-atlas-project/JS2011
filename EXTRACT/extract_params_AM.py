...
realisations_path = '/mnt/qrypfpr220708_americas_run_1.9.2008_try2/realizations_mem_100000000_QRYPFPR220708_Americas_Run_1.9.2008_iterations_FILESTARTREL_FILEENDREL.hdf5'
...
exportPathDistributed_country = '/mnt/distributedoutput_country_am_try2/'
exportPathDistributed_perpixel = '/mnt/distributedoutput_perpixel_am_try2/'
 
# location for export of combined extractions (after distributed files joined by extract_combineDistribExtractions.py)
exportPathCombined_country = '/mnt/combinedoutput_country_am_try2/'
exportPathCombined_perpixel = '/mnt/combinedoutput_perpixel_am_try2/'
